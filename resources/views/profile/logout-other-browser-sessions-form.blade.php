<x-jet-action-section>
    <x-slot name="title">
        {{ __('Zarzjądzaj sesjami') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Zarządzaj aktywnymi sesjami i wylogowuj się z nich w innych przeglądarkach i urządzeniach.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('W razie potrzeby możesz wylogować się ze wszystkich innych sesji przeglądarki na wszystkich swoich urządzeniach. Jeśli uważasz, że ktoś włamał się na Twoje konto, zaktualizuj również swoje hasło.') }}
        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        {{ __('Ostatnia aktywność') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
